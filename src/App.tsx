  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans flex flex-col lg:overflow-hidden">
      ...
      <main className="flex-1 flex flex-col lg:flex-row mt-16 lg:mt-20 lg:h-[calc(100vh-5rem)]">
        ...
        {/* Left: Star Canvas (60%) */}
        <div className="w-full lg:w-[60%] h-[45vh] lg:h-full relative bg-black shrink-0">
        ...
        <div className="w-full lg:w-[40%] lg:h-full lg:overflow-y-auto overscroll-none custom-scrollbar bg-[#050914] relative border-t lg:border-t-0 lg:border-l border-slate-800 p-4 sm:p-6 lg:p-8 pb-24 lg:pb-8">
